...
namespace std_msgs
{
  ...
  class UInt16MultiArray : public ros::Msg
  {
    ...
    virtual const char * getType()const override { return "std_msgs/UInt16MultiArray"; };
    virtual const char * getMD5()const override { return "52f264f1c973c4b73790d384c6cb4484"; };
